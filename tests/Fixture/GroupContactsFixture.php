 ...
 */
class GroupContactsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'group_contacts_ibfk_1' => ['type' => 'foreign', 'columns' => ['contact_id'], 'references' => ['contacts', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'group_contacts_ibfk_2' => ['type' => 'foreign', 'columns' => ['group_id'], 'references' => ['groups', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'group_id' => 1,
                'contact_id' => 1,
                'created' => '2019-04-05 02:18:46',
                'updated' => '2019-04-05 02:18:46'
            ],
        ];
        parent::init();
    }
